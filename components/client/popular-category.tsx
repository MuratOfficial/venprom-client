...
function PopularCategory() {
  return (
    <div className="w-full  flex flex-col relative">
      ...
      <div className="flex xs:px-4 xxs:px-2 lg:px-48 xs:h-full lg:h-screen flex-col py-4 relative w-full before:block before:absolute before:-inset-1 before:skew-y-3  before:bg-[#271fc6]  inline-block">
        <AnimateScrollDown>
          <p className="uppercase text-3xl items-center justify-center flex flex-row gap-x-4 text-center font-bold text-neutral-100 py-8 relative">
            ...
            <BadgePercent
              size={35}
              className="lg:visible xs:collapse lg:w-fit xs:w-fit
               xxs:w-0 xxs:collapse"
            />
          </p>
        </AnimateScrollDown>
